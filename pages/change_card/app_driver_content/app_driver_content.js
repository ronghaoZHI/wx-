  ...
  onLoad: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        if (res.data.ad == 3) {
          that.setData({
            name: res.data.de2.name,
            mobile: res.data.de2.mobile,
            price: res.data.de2.price,
            car_card: res.data.de2.car_card,
            route: res.data.de2.route,
            cartype: res.data.de2.cartype,
            load: res.data.de2.load,
            loadcube: res.data.de2.loadcube,
            address: res.data.de2.address,
