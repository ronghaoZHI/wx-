...
//发现人力资源编号
var resource_id = 0
function set_resource_id(content, e, ) {
  var that = content
  resource_id = that.data.resource_id
  console.log(that.data.resource_id+"人力资源id111")
}
function get_resource_id(content, e) {
  var that = content
  that.setData({
    resource_id: resource_id
  })
  console.log(that.data.resource_id + "人力资源id2222")
}
//入驻商家编号
var vender_id = 0
function set_vender_id(content, e, ) {
  var that = content
  vender_id = that.data.vender_id
  console.log(that.data.vender_id + "入驻商家id111")
}
function get_vender_id(content, e) {
  var that = content
  that.setData({
    vender_id: vender_id
  })
  console.log(that.data.vender_id + "入驻商家id2222")
}
//多张图片上传
...
module.exports.set_resource_id = set_resource_id//人力资源编号
module.exports.get_resource_id = get_resource_id
module.exports.set_vender_id = set_vender_id//入驻商家编号
module.exports.get_vender_id = get_vender_id
